...
const JEJU_L2_TABLE = [
  ...
  { code: 'SP-DO-JACHI',    file: '02-do-dept/SP-DO-JACHI_v1.1.md',
    ...
    kw: ['특별자치행정국', '특별자치', '자치분권', '제주특별법', '4·3지원', '자치행정', '총무', '회계재산관리'] },
  ...
  { code: 'SP-DO-INNOV',    file: '02-do-dept/SP-DO-INNOV_v1.3.md',
    ...
    // 기후에너지국(SP 미작성) 소관으로 이관돼 삭제 — 이 부서에 걸리면
    // 안내가 부정확해진다.
    kw: ['미래산업국', '혁신산업국', '디지털', 'AI산업', '스타트업', '첨단산업', '전략산업', '우주산업', '모빌리티', '디지털혁신', '미래성장', '에너지산업', '우주모빌리티'] },
  ...
  { code: 'SP-DO-CLIMATE',  file: '02-do-dept/SP-DO-CLIMATE_v1.3.md',
    ...
    // 충분히 잡힌다.
    kw: ['기후환경국', '전기차', '탄소중립', '환경영향평가', '클린하우스', '폐기물', '환경', '물정책', '산림녹지', '자원순환', '환경정책'] },
  { code: 'SP-DO-HOUSING',  file: '02-do-dept/SP-DO-HOUSING_v1.1.md',
    ...
    // 라우팅되던 버그의 근본 원인.
    kw: ['건설주택국', '공공임대주택', '주택정책', '주택', '전세자금대출', '건설', '건축경관', '도로관리', '주택토지'] },  // ★ 2026-09-15 추가(gov24_corpus batch6 발견) — "버팀목전세자금대출"이 '주택' 등 기존 키워드와 안 겹쳐 LLM 폴백에서 엉뚱하게 SP-NAT-BOK(한국은행)로 오확정됨. 전세자금대출은 주택도시기금 계열 상품이라 HOUSING이 맞음.
  { code: 'SP-DO-TRANSPORT',file: '02-do-dept/SP-DO-TRANSPORT_v1.1.md',
    domain: 'transport', 도코드: 'jeju',
    kw: ['교통항공국', '버스', '준공영제', '교통약자', '콜택시', '공영주차장', '공항', '제2공항', '교통', '15분도시', '교통정책', '대중교통', '도시계획'] },
  { code: 'SP-DO-CULTURE',  file: '02-do-dept/SP-DO-CULTURE_v1.1.md',
    domain: 'culture', 도코드: 'jeju',
    kw: ['문화체육교육국', '생활체육', '평생교육', '평생학습', '문화예술', '체육', '도서관', '문화', '교육정책협력', '문화정책', '체육진흥'] },
  { code: 'SP-DO-TOURISM',  file: '02-do-dept/SP-DO-TOURISM_v1.2.md',
    domain: 'tourism', 도코드: 'jeju',
    kw: ['관광교류국', '관광지', '숙박업', '게스트하우스', '여행업', '국제교류', '관광', '관광산업', '관광정책', '평화외교'] },
  { code: 'SP-DO-AGRI',     file: '02-do-dept/SP-DO-AGRI_v1.1.md',
    domain: 'agri', 도코드: 'jeju',
    kw: ['농축산식품국', '농업경영체', '공익직불금', '농산물재해보험', '축산', '농업', '농사', '감귤유통', '동물방역', '식품산업', '친환경농업정책', '친환경축산정책'] },
  { code: 'SP-DO-OCEAN',    file: '02-do-dept/SP-DO-OCEAN_v1.1.md',
    domain: 'ocean', 도코드: 'jeju',
    kw: ['해양수산국', '어업면허', '마을어장', '수산업', '양식업', '어업', '수산', '수산정책', '해녀문화유산', '해양산업', '해운항만'] },
  ...
  { code: 'SP-DO-COMM',     file: '02-do-dept/SP-DO-COMM_v1.3.md',
    ...
    // SP-DO-INTEGRITY)으로 분리됨. '청렴'/'감사' 키워드를 그쪽으로
    // 이동하고, 이 항목은 소통 기능만 남긴다.
    kw: ['소통담당관', '소통청렴담당관', '대민소통', '도민소통', '갈등관리'] },
  { code: 'SP-DO-INTEGRITY', file: '02-do-dept/SP-DO-INTEGRITY_v1.0.md',
    // ★ 2026-09-16 신설 — 조직도 스크린샷에서 '청렴감찰관'이 독립 박스로
    // 확인됨(기존 SP-DO-COMM에서 분리). domain/도코드 미부여 —
    // do-dept-master-data.json에 대응 레코드가 아직 없어 static 경로.
    kw: ['청렴감찰관', '공직비리', '부조리신고', '청렴', '감사', '공직감찰'] },
  { code: 'SP-DO-LABOR',   file: '02-do-dept/SP-DO-LABOR_v1.0.md',
    // ★ 2026-09-16 신설 — 조직도 스크린샷에서 최초 식별. 머니투데이
    // (2026-09-10) 확인 — 전국 지방정부 최초 노동감독 전담조직,
    // 2026-08-25 설치. 국가기관(지방고용노동청, domain: 'labor',
  ...
  { code: 'SP-DO-AIGOV',   file: '02-do-dept/SP-DO-AIGOV_v1.1.md',
    ...
    // 겹치지 않게 구성(“AI산업”은 INNOV, “AI행정”은 이쪽).
    kw: ['AI행정혁신추진단', 'AI행정서비스', '데이터기반 행정', 'AI인재양성', '행정 디지털전환'] },
  { code: 'SP-DO-BASICSOC', file: '02-do-dept/SP-DO-BASICSOC_v1.0.md',
    // ★ 2026-09-16 신설 — 조직도 스크린샷에서 최초 식별. 세계일보
...
const JEJU_CITY_DEPT_TABLE = [
  { 국코드: 'jachi', 시코드: 'jejusi',
    ...
    kw: ['자치행정국', '총무과', '기획예산과', '세무과', '재산세과', '지방세', '여권', '자동차세', '재산세', '지방공무원경력증명', '지방공무원 경력증명', '기획예산', '등록면허세', '선거 관련 행정지원', '설치준비지원단', '시정 전반의 기획', '예산편성', '읍면동 행정 총괄', '자치행정', '주민자치', '취득세', '마을공동체 관련 업무', '자치행정과'] },  // ★ 2026-08-23 '자동차세'·'재산세'·'지방공무원경력증명'(띄어쓰기 변형 포함) 추가(사고실험 발견) — 취득세 등과 동일하게 개별 세목은 시청 세무과 소관
  { 국코드: 'safety', 시코드: 'jejusi',
    // ★ 2026-09-16 수정 — 조직도 스크린샷(1차 사료) 확인 결과 '안전교통국'
    // →'안전교통위생국'으로 개편, 식품안전과·위생관리과(舊 복지위생국)가
    // 이 국으로 이관. 위생 관련 kw는 WELFARE에서 그대로 옮겨왔다.
    kw: ['안전교통위생국', '안전교통국', '안전총괄과', '교통행정과', '차량관리과', '교통', '차량등록', '주정차', '자동차등록', '자동차 등록', '자동차 말소', '식품안전과', '위생관리과', '공중위생업 인허가', '식품위생업소', '교통행정', '민방위', '식중독', '식품안전', '안전총괄', '위생관리', '위해식품', '이전등록', '차고지증명제 운영', '차량관리', '재난안전대책본부 운영', '제주시 관내 시내버스'] },  // ★ 2026-08-23 '자동차등록'·'자동차 말소' 추가(사고실험 발견) — "자동차등록증 재발급" 등 실발화형은 '차량등록'과 어순이 달라 안 걸렸음. '자동차 등록'(띄어쓰기)도 추가
  { 국코드: 'welfare', 시코드: 'jejusi',
    ...
    // 공백이었다 — 추가.
    // ★ 2026-09-16 수정 — '위생관리과'는 안전교통위생국으로 이관(중복
    // 제거), 통합돌봄과 신설 확인(제주가치 통합돌봄 서비스 창구).
    // 국명도 복지위생국→복지가족국.
    kw: ['복지가족국', '복지위생국', '주민복지과', '노인복지과', '장애인복지과', '기초생활보장과', '여성가족과', '기초생활수급', '통합돌봄과', '통합돌봄', '제주가치 통합돌봄', '가사지원', '가정폭력', '경로당 지원', '기초생활보장', '기초연금', '긴급돌봄', '긴급복지지원', '노인복지', '노인일자리', '복지 총괄', '성폭력 피해자 보호', '여성가족', '여성긴급전화 연계', '장애수당', '장애인 등록', '장애인복지', '장애인연금', '주민복지', '한부모가족 지원', '국민기초생활보장 신청', '사회보장급여 총괄 조정', '장애인 활동지원 신청'] },
  { 국코드: 'econ', 시코드: 'jejusi',
    // ★ 2026-09-16 수정 — 정보화지원과→디지털혁신과 명칭변경 확인.
    kw: ['경제일자리국', '경제소상공인과', '일자리에너지과', '마을활력과', '디지털혁신과', '정보화지원과', '소상공인', '일자리', '통신판매업', '경제소상공인', '공공일자리사업', '디지털혁신', '마을만들기', '마을활력', '소상공인 지원', '에너지 절약', '일자리에너지', '전통시장 활성화', '정보화교육', '정보화지원', '스마트시티 관련 사업', '신재생에너지 보급 지원'] },  // ★ 2026-08-23 '통신판매업' 추가(사고실험 발견)
  { 국코드: 'comm', 시코드: 'jejusi',
    // ★ 2026-09-16 신설 — 조직도 스크린샷에서 부시장 직속 확인.
    kw: ['소통청렴지원실', '시정 소통', '청렴신고', '공직감찰'] },
  { 국코드: 'pr', 시코드: 'jejusi',
    kw: ['공보실', '시정 홍보', '보도자료'] },
  { 국코드: 'civilaffairs', 시코드: 'jejusi',
    kw: ['종합민원실', '통합 민원', '민원 접수처'] },
  { 국코드: 'culture', 시코드: 'jejusi',
    kw: ['문화관광체육국', '문화예술과', '관광진흥과', '체육진흥과', '우당도서관', '탐라도서관', '제주아트센터', '문화', '관광', '체육', '공공체육시설 관리', '관광사업체 등록', '관광안내소 운영', '관광진흥', '문화예술', '문화예술 지원사업', '전시 행정', '제주시립 우당도서관', '제주시립 탐라도서관', '제주아트', '체육 진흥', '체육진흥', '대관'] },
  { 국코드: 'climate', 시코드: 'jejusi',
    kw: ['청정환경국', '환경관리과', '환경지도과', '생활환경과', '공원녹지과', '절물생태관리소', '환경', '공원', '가로수 관리', '공원녹지', '도시공원', '매립시설 운영', '생활환경', '수질 관리', '재활용 정책', '절물생태', '절물자연휴양림 운영', '폐기물 소각', '폐기물 수거', '환경 총괄', '환경관리', '환경시설', '환경시설관리소', '환경오염 단속', '환경지도', '폐기물 배출업소 지도'] },
  { 국코드: 'housing', 시코드: 'jejusi',
    ...
    kw: ['도시건설국', '도시계획과', '도시재생과', '건축과', '주택과', '상하수도과', '건축', '건축허가', '건축인허가', '건축신고', '도시계획', '개별공시지가', '토지이용계획', '조상 땅 찾기', '건축 인허가', '건축물 안전점검', '공동주택 관리', '뉴딜사업', '도로 파손', '도로점용허가', '도시관리계획', '도시재생', '배수 민원', '사용승인', '상수도', '상하수도', '용도지역', '원도심 활성화', '임대주택', '주거환경개선사업', '주택사업계획승인', '준공검사', '지구단위계획', '토목시설', '하수도 시설 관리', '건설과', '건설'] },  // ★ 2026-08-23 '개별공시지가'·'토지이용계획'·'조상 땅 찾기' 추가(사고실험 발견)
  { 국코드: 'agri', 시코드: 'jejusi',
    // ★ 2026-09-16 신설 — jejusi.go.kr 조직도 스크린샷(1차 사료)에서
    // '농수축산국'이 자치행정국 등 8개 국 중 하나로 확인됐으나 이 테이블에
    // 전혀 없던 완전 공백이었다(division 테이블도 마찬가지로 없었음,
    // 같은 세션에서 함께 신설). 오늘 do-dept 티어에서 발견한 것과 동일한
    // "L2 게이트가 division 내용어를 몰라 2단계까지 도달 못 하는" 버그를
    // 예방하기 위해 division급 내용어(친환경농정/감귤유통/해양수산/
    // 청정축산)를 처음부터 이 목록에 포함한다.
    kw: ['농수축산국', '친환경농정과', '감귤유통과', '해양수산과', '청정축산과',
         '친환경농정', '감귤유통', '해양수산', '청정축산', '농업', '감귤', '축산', '어업'] },
  { 국코드: 'health', 시코드: 'jejusi',
    // ★ 2026-09-16 신설 — 위와 동일 사유(제주보건소 완전 공백).
    kw: ['제주보건소', '보건행정과', '감염예방의약과', '건강증진과', '서부보건소', '동부보건소', '보건행정', '감염예방의약', '건강증진', '보건소', '보건', '예방접종', '동부보건', '서부보건'] },
  { 국코드: 'jachi', 시코드: 'seogwipo',
    // ★ 2026-08-22 추가(사고실험으로 발견) — jejusi와 동일 사유, '여권'.
    kw: ['자치행정국', '총무과', '기획예산과', '세무과', '평생교육과', '지방세', '여권', '자동차세', '인사', '계약', '청사관리', '경리', '기록물통계', '의회법무', '인구청년정책', '자치지원', '4.3지원', '교류협력', '마을발전지원', '교육지원', '평생학습', '자기주도학습센터', '세정', '부과', '체납관리', '과표관리', '세입관리', '기초자치단체 부활', '기획예산', '마을만들기', '마을활력', '마을활력과', '선거 행정지원', '시정 기획', '예산편성', '읍면동 행정 총괄', '의전', '일반서무', '자치행정', '자치행정과', '조직관리', '취득세', '평생교육', '평생교육 프로그램'] },  // ★ 2026-08-23 '자동차세' 추가(사고실험 발견)
  { 국코드: 'welfare', 시코드: 'seogwipo',
    kw: ['복지위생국', '주민복지과', '노인복지과', '장애인복지과', '여성가족과', '위생관리과', '기초생활수급', '복지행정', '통합조사', '통합관리', '돌봄정책', '돌봄지원', '희망복지지원', '노인요양', '노인돌봄', '장묘문화', '장애인재활', '장애인돌봄', '여성지원', '가족지원', '보육', '어린이집지도', '청소년', '아동지원', '아동보호', '식품위생', '위생지도', '숙박업소점검', '가정폭력', '경로당 지원', '공중위생업 인허가', '기초연금', '긴급복지지원', '노인복지', '노인일자리', '복지 총괄', '성폭력 피해자 보호', '식품위생업', '여성가족', '위생관리', '장애수당', '장애인 등록', '장애인복지', '장애인연금', '제주가치 통합돌봄', '주민복지', '통합돌봄과', '한부모가족 지원', '활동지원 신청'] },
  { 국코드: 'culture', 시코드: 'seogwipo',
    kw: ['문화관광체육국', '문화예술과', '관광진흥과', '체육진흥과', '예술의전당', '도서관운영사무소', '공립미술관', '문화', '관광', '체육', '문화시설', '유산지원', '관광개발', '관광산업', '관광상품', '체육지원', '스포츠마케팅', '체육시설관리', '체육시설조성', '공연기획', '공연운영', '감귤박물관운영', '관광지시설', '학예연구', '공공체육시설 관리', '관광사업체 등록', '관광지', '관광지관리소', '관광진흥', '도서관운영', '문화예술', '문화예술 지원사업 행정', '서귀포예술의전당', '전시', '체육 진흥', '체육진흥', '대관'] },
  { 국코드: 'agrieconomy', 시코드: 'seogwipo',
    kw: ['농수축산경제국', '경제일자리과', '디지털혁신과', '친환경농정과', '감귤유통과', '해양수산과', '청정축산과', '농업', '감귤', '수산', '축산', '소상공인', '통신판매업', '지역경제', '일자리지원', '소상공인기업지원', '시장육성', '에너지관리', '디지털지원', '디지털운영', '정보통신', '정보보호', '농업경영지원', '농지관리', '농업용수관리', '유통지원', '원예특작', '식품산업', '수산진흥', '어선어업', '양식산업', '연안관리', '어촌특화개발', '동물방역', '축산물위생', '축산환경', '동물보호', '가격안정', '가축분뇨 관리', '감귤 관련 조례 집행', '감귤 유통', '감귤유통', '경제일자리', '디지털혁신', '소상공인 지원', '수산물 유통', '어업 면허', '일반 농정', '일자리 정책', '정보화 지원', '지역 디지털 전환', '청정축산', '축산업 허가', '친환경농업 인증', '친환경농정', '해양수산'] },  // ★ 2026-08-23 '소상공인'·'통신판매업' 추가(사고실험 발견) — 경제일자리과가 관할
  { 국코드: 'climate', 시코드: 'seogwipo',
    kw: ['청정환경국', '기후환경과', '생활환경과', '공원녹지과', '산림휴양관리소', '환경', '공원', '탄소중립', '환경보호', '환경보전', '환경미화', '사업장폐기물', '환경시설관리', '자원순환', '클린하우스', '녹지관리', '공원관리', '산지경영', '산림병해충', '서귀포휴양림', '붉은오름휴양림', '가로수 관리', '공원녹지', '기후 관련 인허가', '기후환경', '도시공원', '산림휴양', '생활환경', '수질 관리', '재활용 정책', '폐기물 수거', '환경 총괄'] },
  { 국코드: 'housing', 시코드: 'seogwipo',
    kw: ['안전도시건설국', '안전총괄과', '도시과', '건축과', '건설과', '교통행정과', '상하수도과',
         '건축', '건축허가', '건축인허가', '건축신고', '건설', '도시계획', '상하수도', '개별공시지가', '토지이용계획', '조상 땅 찾기', '안전기획', '재난관리', '복구지원', '하천관리', '산업안전보건', '도시정비', '도시시설', '도시재생', '도시경관조성', '건축행정', '주거복지', '농지산림', '건설행정', '도로시설', '도로관리', '농업기반', '공영버스', '주차환경', '자동차등록', '주차지도', '교통시설', '차고지증명', '경영관리', '요금', '하수', '건축 인허가', '건축물 안전점검', '교통안전시설물 관리', '교통행정', '도로', '도시재생 행정', '민방위', '배수 민원', '상수도', '안전총괄', '재난안전대책본부 운영', '하수도 시설 관리', '하천 등 토목시설 건설', '도시'] },  // ★ 2026-08-23 '개별공시지가'·'토지이용계획'·'조상 땅 찾기' 추가(사고실험 발견)
  { 국코드: 'health', 시코드: 'seogwipo',
    kw: ['서귀포보건소', '보건행정과', '건강증진과', '동부보건소', '서부보건소', '보건소', '보건', '의약관리', '감염병관리', '모자보건', '방문간호', '치매관리', '정신건강', '건강생활지원센터', '건강검진', '건강증진', '동부보건', '만성질환 관리사업', '보건소 행정 총괄', '보건행정', '서부보건', '예방접종', '의료기관 인허가'] },
  { 국코드: 'comm', 시코드: 'seogwipo',
    // ★ 2026-09-16 신설 — 주피터님 제공 서귀포시 기구표(2026-03) 확인.
    kw: ['시민소통지원실', '소통감찰', '공항확충지원', '관광미항지원'] },
  { 국코드: 'pr', 시코드: 'seogwipo',
    kw: ['공보실', '보도', '공보'] },
  { 국코드: 'civilaffairs', 시코드: 'seogwipo',
    kw: ['종합민원실', '가족관계등록', '지적재조사', '지가관리', '부동산관리', '도로명주소', '공유재산관리'] },
];
...
const JEJU_NATIONAL_TABLE = [
  ...
  { code: 'SP-NAT-TAX',
    ...
    kw: ['세무서', '국세', '종합소득세', '부가가치세', '법인세', '홈택스', '사업자등록', '세금 환급금',
         ...
         '폐업사실증명',
         // 2026-09-14 추가 — gov24_corpus_live_smoketest.mjs batch1 라이브
         // 재검증에서 "소득금액증명"(→ SP-NAT-STAT/통계청으로 오탐)과
         // "납세증명서"(지방세 아닌 국세 쪽, → SP-DO-PLAN 로컬 폴백)가
         // 기존 트리거와 안 겹쳐 새는 게 확인됨. '소득확인증명서'와
         // '소득금액증명'은 정부24 기준 이름이 다른 별개 문서라 각각
         // 명시적으로 추가한다.
         '소득금액증명', '납세증명서', '표준재무제표증명원'] },  // ★ 2026-09-15 추가(gov24_corpus batch5·batch6 두 차례 반복 발견) — "표준재무제표증명원"이 기존 트리거와 안 겹쳐 EMD로 낙착되던 게 두 번째 배치에서도 재현돼 확정 갭으로 판단.
  { code: 'SP-NAT-COURT',
  ...
  // ★ 2026-09-14 신설 — gov24_corpus_live_smoketest.mjs batch1 라이브
  // 재검증에서 "대학 졸업증명서/성적증명서/졸업예정증명서" 3건이 전부
  // "매칭 실패" 상태로 무관한 위치 기반 기본값(읍면동)에 떨어지는 게
  // 확인됨(trace: "1단계 힌트 전용 매칭 폴백 — ... 실패"). 다른
  // SP-NAT-* 항목과 성격이 다르다는 걸 의도적으로 구분한다 — 이건 "국가
  // 기관의 제주 지역 사무소"가 아니라 "학생 본인이 소속된 특정 대학교"
  // 자체 시스템(또는 정부24 연계)에서 처리되는 사안이라, 제주라는 지역
  // 개념 자체가 안 맞는다. 그래서 domain/도코드를 일부러 안 채운다 —
  // _fetchNatText()가 domain/도코드 없는 entry는 자동으로 정직한
  // "[정보 없음] ... 정부24(gov.kr) 또는 110으로 확인" 폴백으로 보내주는
  // 기존 메커니즘(entry.file 없는 경우와 동일 경로)을 그대로 활용한다 —
  // 존재하지 않는 "제주 대학교 사무소"를 지어내는 대신, 있는 그대로
  // 정직하게 안내한다. 학교생활기록부(초중고, 나이스 연동)도 같은 성격
  // (특정 학교 소관, 제주 지역 기관 아님)이라 함께 묶는다.
  { code: 'SP-NAT-EDUCERT',
    kw: ['졸업증명서', '졸업예정증명서', '성적증명서', '재학증명서', '수료증명서',
         '학교생활기록부', '검정고시'] },  // ★ 2026-09-15 추가(gov24_corpus batch3 발견) — "검정고시 합격증명서"가 매칭 실패로 EMD 낙착. 바로 '합격증명서'는 다른 시험(공무원·자격증 등) 합격증과 겹칠 위험이 있어, 교육 당국이 주관하는 "검정고시"라는 구체적 명칭만 추가(과잉매칭 회피 원칙 — SP-NAT-POLICE/PROSECUTION과 동일)
  // ★ 2026-09-14 신설 — gov24_corpus batch2 라이브 재검증에서 "하이패스
  // 미납요금 조회", "요금감면일괄신청", "미환급금 신청", "조회를 통한
  // 지원결정통지 출력" 4건이 SP-NAT-EDUCERT와 같은 클래스의 문제로 확인됨:
  // 정부24가 여러 부처 데이터를 통합해서 보여주는 "범부처 자체서비스"라
  // 애초에 대응하는 도(제주) 지역 사무소 개념이 없다(도로공사·행안부·
  // 복지부가 뒤섞여 있고 신청 창구가 정부24 자체임). 존재하지 않는
  // "제주 지역 사무소"로 잘못 보내는 대신 SP-NAT-EDUCERT와 동일한
  // 메커니즘(domain/도코드 미기입 → _fetchNatText()의 정직한 "[정보 없음]
  // ... 정부24(gov.kr) 또는 110으로 확인" 폴백)을 그대로 활용한다.
  // kw는 bare 단어 과잉매칭을 피하기 위해 정부24 실제 서비스명과 최대한
  // 가깝게 복합어로 구성(SP-NAT-POLICE/PROSECUTION과 동일 원칙).
  { code: 'SP-NAT-GOVPLATFORM',
    kw: ['하이패스 미납요금', '요금감면일괄', '요금감면 일괄신청', '미환급금 신청', '미환급금 찾기',
         '지원결정통지 출력', '지원결정통지서 출력',
         // ★ 2026-09-15 추가(gov24_corpus batch7 발견) — "1372 소비자상담센터"가
         // 발화에 따라 한국소비자원/공정거래위원회/식품의약품안전처 등 소관기관이
         // 제각각으로 잡히는데도(정부24 원본 자체가 상품별로 다르게 표기)
         // 실제로는 전부 동일한 "1372 소비자상담센터" 하나의 통합 창구라 제주
         // 지역 사무소 개념이 안 맞음 — 같은 배치 안에서 3건이 전부 매칭 실패로
         // EMD에 낙착돼(우연 아님) 확정 갭으로 판단.
         '1372', '소비자상담센터', '소비자 신고센터'] },
  ...
  { code: 'SP-NAT-LABOR',
    ...
    kw: ['근로복지공단', '산재보험', '산업재해', '고용보험', '가족돌봄휴직',
         ...
         '보험 가입 증명원', '국가기술자격', '내일배움카드'] },  // ★ 2026-08-23 추가(1~5차 사고실험 발견), 2026-09-15 '보험 가입 증명원' 추가(gov24_corpus batch3 발견 — 매칭 실패로 EMD 낙착. 정부24 원본 명칭이 "(근로복지공단)보험 가입 증명원"이라 근로복지공단 소관임이 명확)
  ...
  { code: 'SP-NAT-VETERANS',
    ...
    // ★ 2026-09-26 수정(작업 #21) — '보훈급여' 바레 키워드 제거. 위키백과
    // "제주특별자치도보훈청" 확인 결과 보훈급여금 지급은 도 소속 보훈청
    // 보상과 실무(2006년 이관)이지 국가보훈부 직접 집행이 아니다 — 이
    // 키워드가 있으면 0단계 국가기관 매칭이 즉시 확정돼(경합 감지 이전
    // 단계) 도 기관으로 갈 발화까지 국가기관으로 새는 원인이 될 수 있다.
    // '보훈청'·'국가유공자'는 남긴다 — 명칭이 여전히 겹치므로
    // _localGovCollisionCandidate + LLM 경합 판단(ROUTE_DESCRIPTIONS 정정
    // 완료)에 맡긴다. '취업지원 대상자'는 이관 여부를 확인하지 못해
    // 잠정 유지(재검증 필요).
    kw: ['보훈청', '국가유공자', '취업지원 대상자'] },  // ★ 2026-08-23 '취업지원 대상자' 추가(사고실험 발견) — 이전에 잘못된 자매 테이블(_guessNatAgencyDomainFromText용)에 넣었던 걸 여기(JEJU_NATIONAL_TABLE, 실제 _matchNational이 쓰는 표)로 정정
  ...
  { code: 'SP-NAT-CUSTOMS',
    ...
    kw: ['세관', '관세', '통관', '관세 납세증명서'] },  // ★ 2026-09-15 추가(gov24_corpus batch5 발견) — "관세 등 납세증명서"가 SP-NAT-TAX의 '납세증명서'(2026-09-14 추가)와 동점(각 1개 매칭)이 되면서 배열 순서상 TAX가 먼저 나와 국세청으로 잘못 확정(호출 0회, 관세청 아님). 정부24 실제 명칭 복합어를 추가해 이 경우 CUSTOMS가 2점으로 앞서게 함 — _scoreMatchTies가 매칭 키워드 "개수"로 점수를 매기고 동점 시 배열 순서로 정하는 구조적 특성상, 일반 '관세' 단독 매칭에는 영향 없이 이 특정 충돌만 해소하는 최소 수정.
  { code: 'SP-NAT-BOK',
    domain: 'bok', 도코드: 'jeju',
    kw: ['한국은행'] },
  { code: 'SP-NAT-STAT',
...
const ROUTE_DESCRIPTIONS = {
  ...
  'SP-NAT-EDUCERT': '대학·학교 증명서(졸업·성적·재학·생활기록부 등) [제주 지역 사무소 없음 — 소속 학교 자체 시스템 또는 정부24 연계로 안내]',
  'SP-NAT-GOVPLATFORM': '정부24 범부처 통합 자체서비스(하이패스 미납요금·요금감면일괄·미환급금·지원결정통지 출력·1372 소비자상담센터 등) [특정 기관의 제주 지역 사무소 개념이 안 맞음 — 정부24(gov.kr) 또는 110으로 안내]',
  ...
  // ★ 2026-09-26 수정(작업 #21, 보훈청 라우팅 미해결 건 조사 지시로 확인) —
  // 이전 설명("제주보훈청(국가보훈부)")은 사실과 다르다. 위키백과
  // "제주특별자치도보훈청" 문서 확인 결과, 제주의 보훈청은 2006년 6월 30일
  // 제주특별자치도 설치 및 국제자유도시 조성을 위한 특별법에 따라 국가보훈처
  // 산하 제주보훈지청에서 제주특별자치도 소속으로 이관됐다 — 등록·보상금
  // 지급 등 보훈과·보상과 실무는 도 직속기관(SP-AGY-VETERANS)이 수행한다.
  // 이 SP-NAT-VETERANS 코드는 그 이관 대상에서 제외된, 국가보훈부가 여전히
  // 직접 수행하는 국가 사무(보훈 정책 총괄·서훈 등)만을 가리키도록 설명을
...
const SP_CODE_TO_PDV_SCOPE = {
  ...
  'SP-NAT-GOVPLATFORM': 'kgovplatform',
  // 도 자체 부서
