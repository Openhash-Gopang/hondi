...
const JEJU_CITY_DEPT_TABLE = [
  ...
  { 국코드: 'safety', 시코드: 'jejusi',
    ...
    kw: ['안전교통위생국', '안전교통국', '안전총괄과', '교통행정과', '차량관리과', '교통', '차량등록', '주정차', '자동차등록', '자동차 등록', '자동차 말소',
         '식품안전과', '위생관리과', '공중위생업 인허가', '식품위생업소'] },  // ★ 2026-08-23 '자동차등록'·'자동차 말소' 추가(사고실험 발견) — "자동차등록증 재발급" 등 실발화형은 '차량등록'과 어순이 달라 안 걸렸음. '자동차 등록'(띄어쓰기)도 추가
  { 국코드: 'welfare', 시코드: 'jejusi',
    ...
    // 국명도 복지위생국→복지가족국.
    kw: ['복지가족국', '복지위생국', '주민복지과', '노인복지과', '장애인복지과', '기초생활보장과', '여성가족과', '기초생활수급',
         '통합돌봄과', '통합돌봄', '제주가치 통합돌봄'] },
  { 국코드: 'econ', 시코드: 'jejusi',
    // ★ 2026-09-16 수정 — 정보화지원과→디지털혁신과 명칭변경 확인.
    kw: ['경제일자리국', '경제소상공인과', '일자리에너지과', '마을활력과', '디지털혁신과', '정보화지원과', '소상공인', '일자리', '통신판매업'] },  // ★ 2026-08-23 '통신판매업' 추가(사고실험 발견)
  { 국코드: 'comm', 시코드: 'jejusi',
  ...
  { 국코드: 'health', 시코드: 'jejusi',
    ...
    kw: ['제주보건소', '보건행정과', '감염예방의약과', '건강증진과', '서부보건소', '동부보건소',
         '보건행정', '감염예방의약', '건강증진', '보건소', '보건', '예방접종'] },
