...
const JEJU_L2_TABLE = [
  ...
  { code: 'SP-DO-INNOV',    file: '02-do-dept/SP-DO-INNOV_v1.2.md',
    ...
    // 안내가 부정확해진다.
    kw: ['미래산업국', '혁신산업국', '디지털', 'AI산업', '스타트업', '첨단산업', '전략산업', '우주산업', '모빌리티'] },
  ...
  { code: 'SP-DO-HOUSING',  file: '02-do-dept/SP-DO-HOUSING_v1.1.md',
    ...
    // 라우팅되던 버그의 근본 원인.
    kw: ['건설주택국', '공공임대주택', '주택정책', '주택', '전세자금대출'] },  // ★ 2026-09-15 추가(gov24_corpus batch6 발견) — "버팀목전세자금대출"이 '주택' 등 기존 키워드와 안 겹쳐 LLM 폴백에서 엉뚱하게 SP-NAT-BOK(한국은행)로 오확정됨. 전세자금대출은 주택도시기금 계열 상품이라 HOUSING이 맞음.
