...
const JEJU_CITY_DEPT_TABLE = [
  { 국코드: 'jachi', 시코드: 'jejusi',
    ...
    kw: ['자치행정국', '총무과', '기획예산과', '세무과', '재산세과', '지방세', '여권', '자동차세', '재산세', '지방공무원경력증명', '지방공무원 경력증명', '기획예산', '등록면허세', '선거 관련 행정지원', '설치준비지원단', '시정 전반의 기획', '예산편성', '읍면동 행정 총괄', '자치행정', '주민자치', '취득세'] },  // ★ 2026-08-23 '자동차세'·'재산세'·'지방공무원경력증명'(띄어쓰기 변형 포함) 추가(사고실험 발견) — 취득세 등과 동일하게 개별 세목은 시청 세무과 소관
  { 국코드: 'safety', 시코드: 'jejusi',
    ...
    kw: ['안전교통위생국', '안전교통국', '안전총괄과', '교통행정과', '차량관리과', '교통', '차량등록', '주정차', '자동차등록', '자동차 등록', '자동차 말소', '식품안전과', '위생관리과', '공중위생업 인허가', '식품위생업소', '교통행정', '민방위', '식중독', '식품안전', '안전총괄', '위생관리', '위해식품', '이전등록', '차고지증명제 운영', '차량관리'] },  // ★ 2026-08-23 '자동차등록'·'자동차 말소' 추가(사고실험 발견) — "자동차등록증 재발급" 등 실발화형은 '차량등록'과 어순이 달라 안 걸렸음. '자동차 등록'(띄어쓰기)도 추가
  { 국코드: 'welfare', 시코드: 'jejusi',
    ...
    // 국명도 복지위생국→복지가족국.
    kw: ['복지가족국', '복지위생국', '주민복지과', '노인복지과', '장애인복지과', '기초생활보장과', '여성가족과', '기초생활수급', '통합돌봄과', '통합돌봄', '제주가치 통합돌봄', '가사지원', '가정폭력', '경로당 지원', '기초생활보장', '기초연금', '긴급돌봄', '긴급복지지원', '노인복지', '노인일자리', '복지 총괄', '성폭력 피해자 보호', '여성가족', '여성긴급전화 연계', '장애수당', '장애인 등록', '장애인복지', '장애인연금', '주민복지', '한부모가족 지원'] },
  { 국코드: 'econ', 시코드: 'jejusi',
    // ★ 2026-09-16 수정 — 정보화지원과→디지털혁신과 명칭변경 확인.
    kw: ['경제일자리국', '경제소상공인과', '일자리에너지과', '마을활력과', '디지털혁신과', '정보화지원과', '소상공인', '일자리', '통신판매업', '경제소상공인', '공공일자리사업', '디지털혁신', '마을만들기', '마을활력', '소상공인 지원', '에너지 절약', '일자리에너지', '전통시장 활성화', '정보화교육', '정보화지원'] },  // ★ 2026-08-23 '통신판매업' 추가(사고실험 발견)
  { 국코드: 'comm', 시코드: 'jejusi',
  ...
  { 국코드: 'culture', 시코드: 'jejusi',
    kw: ['문화관광체육국', '문화예술과', '관광진흥과', '체육진흥과', '우당도서관', '탐라도서관', '제주아트센터', '문화', '관광', '체육', '공공체육시설 관리', '관광사업체 등록', '관광안내소 운영', '관광진흥', '문화예술', '문화예술 지원사업', '전시 행정', '제주시립 우당도서관', '제주시립 탐라도서관', '제주아트', '체육 진흥', '체육진흥'] },
  { 국코드: 'climate', 시코드: 'jejusi',
    kw: ['청정환경국', '환경관리과', '환경지도과', '생활환경과', '공원녹지과', '절물생태관리소', '환경', '공원', '가로수 관리', '공원녹지', '도시공원', '매립시설 운영', '생활환경', '수질 관리', '재활용 정책', '절물생태', '절물자연휴양림 운영', '폐기물 소각', '폐기물 수거', '환경 총괄', '환경관리', '환경시설', '환경시설관리소', '환경오염 단속', '환경지도'] },
  { 국코드: 'housing', 시코드: 'jejusi',
    ...
    kw: ['도시건설국', '도시계획과', '도시재생과', '건축과', '주택과', '상하수도과', '건축', '건축허가', '건축인허가', '건축신고', '도시계획', '개별공시지가', '토지이용계획', '조상 땅 찾기', '건축 인허가', '건축물 안전점검', '공동주택 관리', '뉴딜사업', '도로 파손', '도로점용허가', '도시관리계획', '도시재생', '배수 민원', '사용승인', '상수도', '상하수도', '용도지역', '원도심 활성화', '임대주택', '주거환경개선사업', '주택사업계획승인', '준공검사', '지구단위계획', '토목시설', '하수도 시설 관리'] },  // ★ 2026-08-23 '개별공시지가'·'토지이용계획'·'조상 땅 찾기' 추가(사고실험 발견)
  { 국코드: 'agri', 시코드: 'jejusi',
  ...
  { 국코드: 'jachi', 시코드: 'seogwipo',
    ...
    kw: ['자치행정국', '총무과', '기획예산과', '세무과', '평생교육과', '지방세', '여권', '자동차세', '인사', '계약', '청사관리', '경리', '기록물통계', '의회법무', '인구청년정책', '자치지원', '4.3지원', '교류협력', '마을발전지원', '교육지원', '평생학습', '자기주도학습센터', '세정', '부과', '체납관리', '과표관리', '세입관리'] },  // ★ 2026-08-23 '자동차세' 추가(사고실험 발견)
  { 국코드: 'welfare', 시코드: 'seogwipo',
    kw: ['복지위생국', '주민복지과', '노인복지과', '장애인복지과', '여성가족과', '위생관리과', '기초생활수급', '복지행정', '통합조사', '통합관리', '돌봄정책', '돌봄지원', '희망복지지원', '노인요양', '노인돌봄', '장묘문화', '장애인재활', '장애인돌봄', '여성지원', '가족지원', '보육', '어린이집지도', '청소년', '아동지원', '아동보호', '식품위생', '위생지도', '숙박업소점검'] },
  { 국코드: 'culture', 시코드: 'seogwipo',
    kw: ['문화관광체육국', '문화예술과', '관광진흥과', '체육진흥과', '예술의전당', '도서관운영사무소', '공립미술관', '문화', '관광', '체육', '문화시설', '유산지원', '관광개발', '관광산업', '관광상품', '체육지원', '스포츠마케팅', '체육시설관리', '체육시설조성', '공연기획', '공연운영', '감귤박물관운영', '관광지시설', '학예연구'] },
  { 국코드: 'agrieconomy', 시코드: 'seogwipo',
    kw: ['농수축산경제국', '경제일자리과', '디지털혁신과', '친환경농정과', '감귤유통과', '해양수산과', '청정축산과', '농업', '감귤', '수산', '축산', '소상공인', '통신판매업', '지역경제', '일자리지원', '소상공인기업지원', '시장육성', '에너지관리', '디지털지원', '디지털운영', '정보통신', '정보보호', '농업경영지원', '농지관리', '농업용수관리', '유통지원', '원예특작', '식품산업', '수산진흥', '어선어업', '양식산업', '연안관리', '어촌특화개발', '동물방역', '축산물위생', '축산환경', '동물보호'] },  // ★ 2026-08-23 '소상공인'·'통신판매업' 추가(사고실험 발견) — 경제일자리과가 관할
  { 국코드: 'climate', 시코드: 'seogwipo',
    kw: ['청정환경국', '기후환경과', '생활환경과', '공원녹지과', '산림휴양관리소', '환경', '공원', '탄소중립', '환경보호', '환경보전', '환경미화', '사업장폐기물', '환경시설관리', '자원순환', '클린하우스', '녹지관리', '공원관리', '산지경영', '산림병해충', '서귀포휴양림', '붉은오름휴양림'] },
  { 국코드: 'housing', 시코드: 'seogwipo',
    kw: ['안전도시건설국', '안전총괄과', '도시과', '건축과', '건설과', '교통행정과', '상하수도과',
         '건축', '건축허가', '건축인허가', '건축신고', '건설', '도시계획', '상하수도', '개별공시지가', '토지이용계획', '조상 땅 찾기', '안전기획', '재난관리', '복구지원', '하천관리', '산업안전보건', '도시정비', '도시시설', '도시재생', '도시경관조성', '건축행정', '주거복지', '농지산림', '건설행정', '도로시설', '도로관리', '농업기반', '공영버스', '주차환경', '자동차등록', '주차지도', '교통시설', '차고지증명', '경영관리', '요금', '하수'] },  // ★ 2026-08-23 '개별공시지가'·'토지이용계획'·'조상 땅 찾기' 추가(사고실험 발견)
  { 국코드: 'health', 시코드: 'seogwipo',
    kw: ['서귀포보건소', '보건행정과', '건강증진과', '동부보건소', '서부보건소', '보건소', '보건', '의약관리', '감염병관리', '모자보건', '방문간호', '치매관리', '정신건강', '건강생활지원센터'] },
